...
export default function ProjectsPage() {
  ...
  // This will be populated from MDX in the actual implementation
  // For now, static data that matches the MDX files
  const projects = [
    {
      slug: "biochatter",
      title: "BioChatter",
            ...
            {projects.map((project) => {
              ...
              return (
                <Link key={project.slug} href={`/projects/${project.slug}`}>
                  <div className={`group relative bg-gradient-to-br ${colors.bg} backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:${colors.border} transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:${colors.shadow} h-full`}>
